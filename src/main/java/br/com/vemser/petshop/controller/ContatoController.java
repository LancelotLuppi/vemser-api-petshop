...
public class ContatoController {
    ...
    public ResponseEntity<List<ContatoDTO>> buscarPorIdCliente(@PathVariable("idCliente") Integer id) {
        return ResponseEntity.ok(contatoService.listarContatoPorId(id));
    }

    @PostMapping("/{idCliente}")
    public ResponseEntity<ContatoDTO> criarContatoPorCliente(@PathVariable("idCliente") Integer id, @Valid @RequestBody ContatoCreateDTO contato) {
    ...
    public ResponseEntity<ContatoDTO> atualizarContato(@PathVariable("idContato") Integer id,
                                                       @Valid @RequestBody ContatoCreateDTO contatoAtualizado){
