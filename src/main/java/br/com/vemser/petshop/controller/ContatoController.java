...
public class ContatoController {
    ...
    public ResponseEntity<List<ContatoDTO>> buscarPorIdCliente(@PathVariable("idCliente") Integer id) throws SQLException {
        return ResponseEntity.ok(contatoService.listarContatoPorId(id));
    }

    @PostMapping("/{idCliente}")
    public ResponseEntity<ContatoDTO> criarContatoPorCliente(@PathVariable("idCliente") Integer id, @Valid @RequestBody ContatoCreateDTO contato) throws SQLException {
    ...
    public ResponseEntity<ContatoDTO> atualizarContato(@PathVariable("idContato") Integer id,
                                                       @Valid @RequestBody ContatoCreateDTO contatoAtualizado) throws SQLException {
        return ResponseEntity.ok(contatoService.update(id, contatoAtualizado));
    }

    @DeleteMapping("/{idContato}")
    public void delete(@PathVariable("idContato") Integer id) throws SQLException {
