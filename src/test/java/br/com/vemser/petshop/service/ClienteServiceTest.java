...
//
//    @Test
//    public void deveTestarCreateComSucesso() throws EntidadeNaoEncontradaException, RegraDeNegocioException, JsonProcessingException {
...
//    public void deveTestarCreateComCliente() throws RegraDeNegocioException, EntidadeNaoEncontradaException, JsonProcessingException {
//        ClienteCreateDTO clienteCreateDTO = getClienteCreateDTO();
//        UsuarioEntity loggedUser = getUsuarioEntity();
...
//
//    @Test
//    public void deveTestarDeleteComSucesso() throws EntidadeNaoEncontradaException, JsonProcessingException {
//        Optional<ClienteEntity> cliente = Optional.of(getClienteEntity());
//
//        when(clienteRepository.findById(any(Integer.class))).thenReturn(cliente);
...
//
//    @Test
//    public void deveTestarUpdateComSucesso() throws EntidadeNaoEncontradaException, JsonProcessingException {
//        ClienteCreateDTO clienteCreateDTO = getClienteCreateDTO();
//        Optional<ClienteEntity> cliente = Optional.of(getClienteEntity());
//
//        when(clienteRepository.findById(any(Integer.class))).thenReturn(cliente);
